...
def varobs_read(obsin,obscnt=None,offset=0,obs_field="obs_data",field_id=98,col_list=["batch","ob_num","field","level","lat","lon"]):
...
def omb_calc(thread,datalist,obsin,bkgin,obscnt=None,offset=0,obs_field="hlosw_obs",bkg_field="hlosw_bkg",field_id=98):
	...
	obscnt=1
	offset=indx
     	obs_list=["batch","ob_num","field","level","lat","lon","pge","ob_error"]
